...
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('pegawai.pelanggan') }}" class="btn btn-outline-primary btn-sm px-3" style="border-radius:10px"><i class="bi bi-arrow-left me-1"></i>Kembali</a>
    </div>
    ...
    <div class="table-box">
        ...
        <div class="p-3 table-responsive">
            <table class="table table-hover align-middle text-center" style="font-size:13px">
                ...
                <tr>
                    <td>{{ $i+1 }}</td><td>{{ $t->tanggal->format('d/m/Y') }}</td>
                    ...
                    <td>@if($t->status_antar=='Sudah'||$t->status_antar=='Selesai')<span class="badge bg-success-subtle text-success border">Sudah Diantar</span>@elseif($t->ongkos_kirim<=0)<span class="badge bg-light text-muted border">Ambil Sendiri</span>@else<span class="badge bg-warning text-dark">Belum</span>@endif</td>
                </tr>
